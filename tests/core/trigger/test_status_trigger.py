...
def test_status_trigger_complete(status_simple_flow):
    task1 = status_simple_flow.task1
    task2 = status_simple_flow.task2
    ...
    container1 = status_simple_flow.container1
    task9 = status_simple_flow.task9
    task3 = status_simple_flow.task3
    task4 = status_simple_flow.task4
